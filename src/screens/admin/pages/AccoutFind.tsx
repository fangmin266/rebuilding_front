        ...
        <div className='w-full bg-gray-100 h-screen'>
            <div className='w-full bg-white'>
                <div className=' w-[960px] mx-auto'>
                    ...
                    {tabs?.map((el)=>(
                    <li className={'py-3 cursor-pointer '+(el===onTab?" text-green-400 border-b border-green-400 ":" text-gray-400 ")}
            ...
            <form className='w-full border-t  py-4' onSubmit={onSubmitFind}>
                <div className='w-[396px] mx-auto'>
                    <p className='w-3/5 leading-5 text-sm text-gray-500 pb-8'>가입하셨던 이메일 계정을 입력하시면, 비밀번호를 새로 만들 수 있는 링크를 이메일로 발송해드립니다.</p>
