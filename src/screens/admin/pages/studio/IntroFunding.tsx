    ...
    return (
      <div className="border px-6 py-2 mt-4 mb-8">
        <div className="flex justify-between items-center">
          ...
          <span className="text-gray-500 underline cursor-pointer text-xs">
            지금 나의 단계는?
          </span>
        </div>
        <div className="flex gap-x-2 items-center pt-2">
          <span
            className={
              ...
              (proceed === "작성중" ? " bg-green-500 " : " bg-blue-500")
            }
          ></span>
          <span>{proceed}</span>
        </div>
        {proceed === "작성중" && (
          <p className="pl-4 text-gray-500 text-sm">
            아래의 필수 항목들이 모두 작성 완료 상태로 바뀌면 [제출하기]를 누를
            수 있어요.
          </p>
        )}
      </div>
        ...
        {ProjectLink[0].subtitles?.map((el) => (
          <li className="flex justify-between border p-6 relative">
            ...
            <div className="flex gap-x-4 items-center">
              ...
              <span className="text-xs text-primary_100">
                {
                  fundingSelectList.selectStatus.find(
        ...
        <div className="w-full px-16 py-10 flex gap-x-6">
          <div className=" w-2/3">
            ...
            <div className="pt-6">
              ...
              <div>
                <p className="text-gray-500 pt-4 pb-8 text-lg">
              ...
              <ButtonDefault
                title="제출하기"
                bgcolor="bg-primary_100 opacity-40"
                btnWidth="w-[360px]"
                txtcolor="text-white"
              />
            </div>
